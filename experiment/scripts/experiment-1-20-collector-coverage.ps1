function ConvertTo-Exp120UtcIso {
...
function Get-Exp120CollectorLines {
...
function Wait-Exp120CollectorReady {
    param(
...
function New-Exp120CollectorCoverage {
    param(
    ...
    $start = ConvertTo-Exp120UtcIso $CoreInvocationStartedAt; $end = ConvertTo-Exp120UtcIso $CoreInvocationCompletedAt
    ...
    [ordered]@{
        ...
        collectorProcessStartedAt = (ConvertTo-Exp120UtcIso $CollectorProcessStartedAt).ToString('o')
        ...
        collectorProcessCompletedAt = (ConvertTo-Exp120UtcIso $CollectorProcessCompletedAt).ToString('o')
...
function Assert-Exp120CollectorCoverage {
