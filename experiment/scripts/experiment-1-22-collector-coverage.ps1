function ConvertTo-Exp122UtcIso {
...
function Get-Exp122CollectorLines {
...
function Wait-Exp122CollectorReady {
    param(
...
function New-Exp122CollectorCoverage {
    param(
    ...
    $start = ConvertTo-Exp122UtcIso $CoreInvocationStartedAt; $end = ConvertTo-Exp122UtcIso $CoreInvocationCompletedAt
    ...
    [ordered]@{
        ...
        collectorProcessStartedAt = (ConvertTo-Exp122UtcIso $CollectorProcessStartedAt).ToString('o')
        ...
        collectorProcessCompletedAt = (ConvertTo-Exp122UtcIso $CollectorProcessCompletedAt).ToString('o')
...
function Assert-Exp122CollectorCoverage {
